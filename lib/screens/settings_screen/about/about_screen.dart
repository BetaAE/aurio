                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    AdaptiveListTile(
                      ...
                      onTap: () => launchUrl(
                          Uri.parse('https://github.com/betaae'),
                    ...
                    AdaptiveListTile(
                      ...
                      onTap: () => launchUrl(
                          Uri.parse('https://aurio.github.io'),
                          mode: LaunchMode.externalApplication),
                    ),
                     AdaptiveListTile(
                      margin: const EdgeInsets.symmetric(vertical: 4),
                      ...
                      onTap: () => launchUrl(
                          Uri.parse('https://aurio.vercel.app'),
                          mode: LaunchMode.externalApplication),
                    ),
                    AdaptiveListTile(
                      margin: const EdgeInsets.symmetric(vertical: 4),
                    ...
                    AdaptiveListTile(
                      ...
                      onTap: () => launchUrl(
                          Uri.parse(
                              'https://github.com/betaae/aurio/contributors'),
                          mode: LaunchMode.externalApplication),
                    ),
                    AdaptiveListTile(
                      margin: const EdgeInsets.symmetric(vertical: 4),
                    ...
                    AdaptiveListTile(
                      ...
                      onTap: () => launchUrl(
                          Uri.parse(
                              'https://github.com/betaae/aurio/issues/new?assignees=&labels=bug&projects=&template=bug_report.yaml'),
                          mode: LaunchMode.externalApplication),
                    ),
                    AdaptiveListTile(
                      margin: const EdgeInsets.symmetric(vertical: 4),
                      ...
                      onTap: () => launchUrl(
                          Uri.parse(
                              'https://github.com/betaae/aurio/issues/new?assignees=betaae&labels=enhancement%2CFeature+Request&projects=&template=feature_request.yaml'),
                          mode: LaunchMode.externalApplication),
                    ),
                    Center(
                      child: Padding(
